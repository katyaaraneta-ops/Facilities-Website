...
export const LoginPage: React.FC<LoginPageProps> = ({ onLoginSuccess, onBack }) => {
  ...
  return (
    <div className="min-h-screen bg-corporate-50 flex items-center justify-center px-6">
      <div className="max-w-md w-full bg-white p-10 rounded-xl border border-corporate-200 shadow-sm">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-10 pr-4 py-3 bg-corporate-50 border border-corporate-200 rounded-lg focus:ring-1 focus:ring-corporate-900 outline-none" 
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full py-4 bg-corporate-900 text-white font-medium rounded-lg hover:bg-corporate-800 transition-colors flex items-center justify-center gap-2"
          >
